...
require (
	...
	github.com/scorum/cosmos-network v1.0.2
...
require github.com/cheqd/cheqd-node v1.4.4
...
require (
	...
	github.com/bianjieai/nft-transfer v1.1.1-beta.0.20230423022320-36d37f459aab // indirect
